        ...
        <View style={styles.container}>
            <View style={styles.container1}>
                <View style={{ alignSelf: 'center' }}>
                    ...
                    <Text style={styles.valor}>R$ {premio[indice] == 1000 ? 0 : errar} </Text>
                </View>
                <View style={{ alignSelf: 'center' }}>
                    <Text style={styles.posicao}>Acertar </Text>
                    <Text style={styles.valor}>R$ {premio[indice]} </Text>
                </View>
                <View style={{ alignSelf: 'center' }}>
                    <Text style={styles.posicao}>Parar </Text>
                    <Text style={styles.valor}>R$ {premio[indice] == 1000 ? 0 : parar} </Text>
                </View>
            </View>
        </View>
    )
